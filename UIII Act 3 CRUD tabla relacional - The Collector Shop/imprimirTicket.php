...
$setenciaproductos = $base_de_datos->prepare("SELECT v.id, v.nombreprod, v.descripcion, v.precio, vv.cantidad
FROM productos v
INNER JOIN 
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="cantidad"><?php echo $producto->nombreprod;  ?> </td>
                        <td class="cantidad">  <?php echo $producto->descripcion;  ?></td>
